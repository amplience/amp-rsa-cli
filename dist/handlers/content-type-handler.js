...
class ContentTypeHandler extends resource_handler_1.CleanableResourceHandler {
    ...
    import(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield installTypes(context, (0, dc_demostore_integration_1.getCodecs)(dc_demostore_integration_1.CodecTypes.commerce).map(dc_demostore_integration_1.getContentType));
            ...
            yield installTypes(context, lodash_1.default.filter(Object.values(jsonTypes), s => !lodash_1.default.includes(lodash_1.default.map((0, dc_demostore_integration_1.getCodecs)(dc_demostore_integration_1.CodecTypes.commerce), 'schema.uri'), s.contentTypeUri)));
